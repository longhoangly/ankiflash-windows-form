...
class AutoImportWindows(QtWidgets.QWidget):

    def __init__(self):
        super(AutoImportWindows, self).__init__()
        self.move(300, 300)
        self.setFixedSize(600, 82)
        self.setWindowTitle('Auto Import Flashcards v9.1.2')
    ...
    def __btnBrowseClicked(self):
        global basedir
        basedir = QtWidgets.QFileDialog.getExistingDirectory(self, 'Select Generated Flashcards Folder')
...
action.triggered.connect(__importWindow)
